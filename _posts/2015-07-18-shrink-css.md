...
Go to [Node.js](https://nodejs.org/) to get their installer. This will also get you NPM to install the needed packages.
...
You will need to modify your gulp build file to suite your project. On line 5, you will need to specify where your stylesheet is located. On line 7, include all HTML file locations.
