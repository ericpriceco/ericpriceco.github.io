...
You only need a ruby environment setup and the compass and sass gems installed to get started. See my previous post on setting it up. [http://eric-price.net/blog/jekyll-osx/](http://eric-price.net/blog/jekyll-osx/)
