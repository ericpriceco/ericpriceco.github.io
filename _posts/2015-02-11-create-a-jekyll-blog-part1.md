...
published: true
---
I'm going to go through the steps for creating a site and blog using [Jekyll](http://jekyllrb.com/). Jekyll is a static site generator that will convert markdown files and partials into a working website.  See my previous post on how to install Jekyll if you havent already. [http://eric-price.net/blog/jekyll-osx/](http://eric-price.net/blog/jekyll-osx/)
